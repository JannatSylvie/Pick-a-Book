...
public class IssueBook extends JFrame implements MouseListener,ActionListener
{
	private JLabel issuebook,studentid,bookid;
	private JTextField sid,bid;
	private JButton home,issue,back,signout;
	...
	public IssueBook(){
		...
		issuebook = new JLabel(">>Issue Book");
		issuebook.setBounds(25, 25 , 500 , 30);
		issuebook.setFont(new Font("Bradley Hand ITC",Font.BOLD,35));
		...
		issue.setBounds(557 , 367 , 90 , 25);
		issue.setFont(new Font("Bradley Hand ITC",Font.BOLD,22));
		issue.setBackground(Color.GRAY);
	...
	public void mouseEntered(MouseEvent m)
	{
		...
		issue.setForeground(Color.DARK_GRAY);
		}
		else if(btn == back)
		{
	...
	{
		String query = "INSERT INTO issued_books VALUES ('"+sid.getText()+"','"+bid.getText()+"');";
